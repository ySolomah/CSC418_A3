...
int main(int argc, char* argv[])
{
	...
	Material jade(Color(0, 0, 0), Color(0.54,0.89,0.63),
		...
		12.8, 0.1);
	Material cylinderGarb(Color(0.4, 0.4, 0.4), Color(1.0,0.3,0.3),
		Color(0.4,0.1,0.7),
		12.8, 0.5);
	...
	SceneNode* cylinder = new SceneNode(new UnitCylinder(), &cylinderGarb);
	//scene.push_back(cylinder);

	// Apply some transformations to the sphere and unit square.
	double factor1[3] = { 0.1, 0.4, 0.2 };
